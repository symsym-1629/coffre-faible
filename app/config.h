...
#define USE_MLX90614		0 // Capteur de température infrarouge (utilise I2C)
...
#define USE_DHT11			0 // Capteur de température et d'humidit�
...
#define USE_VL53L0			0 // T�l�metre laser de grande précision
#if USE_VL53L0
