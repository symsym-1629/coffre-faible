...
void XPT2046_demo(void)
{
	...
	ILI9341_Puts(25,170, "certains ecrans sont differents", &Font_7x10, ILI9341_COLOR_BROWN, ILI9341_COLOR_WHITE);
	ILI9341_Puts(25,180, "consultez le code pour en savoir plus", &Font_7x10, ILI9341_COLOR_BROWN, ILI9341_COLOR_WHITE);
			/* Le texte ci dessus a attiré votre attention ?
			 * 	Certains des écrans ont une orientation différente des axes x/y.
			 * 	En effet, il existe plusieurs variantes de l'écran ILI9341.
			 * 	Vous devrez peut-être ajuster le contenu de la fonction XPT2046_convertCoordinateScreenMode() pour qu'elle fonctionne correctement avec votre écran.
			 * 	Si vous observez une inversion... charge à vous de réfléchir !
			 */
