...
#define	PIN_INPUT_0		GPIO_PIN_11
#define	PIN_INPUT_1		GPIO_PIN_8
#define	PIN_INPUT_2		GPIO_PIN_6
#define	PIN_INPUT_3		GPIO_PIN_15

#define PORT_OUTPUT_0 	GPIOB
#define PORT_OUTPUT_1 	GPIOB
#define PORT_OUTPUT_2 	GPIOA
#define PORT_OUTPUT_3 	GPIOA
#define	PIN_OUTPUT_0	GPIO_PIN_7
#define	PIN_OUTPUT_1	GPIO_PIN_0
#define	PIN_OUTPUT_2	GPIO_PIN_12
#define	PIN_OUTPUT_3	GPIO_PIN_9
